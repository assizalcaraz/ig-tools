 ...
 * @param {import('./types/id').SvelteRequest} svelteRequest
...
export async function handleHotUpdate(compileSvelte, ctx, svelteRequest, cache, options) {
	...
	/** @type {import('./types/compile').CompileData} */
	let compileData;
	try {
...
/**
 * @param {import('./types/compile').Code} [prev]
 * @param {import('./types/compile').Code} [next]
 * @returns {boolean}
 */
