...
/** @type {import('../types/log').LogLevel[]} */
const levels = ['debug', 'info', 'warn', 'error', 'silent'];
const prefix = 'vite-plugin-svelte';
/** @type {Record<import('../types/log').LogLevel, any>} */
const loggers = {
	debug: {
		log: debug(`${prefix}`),
		enabled: false,
...
let _level = 'info';
/**
 * @param {import('../types/log').LogLevel} level
 * @returns {void}
 */
...
/**
 * @param {import('../types/log').LogLevel} level
 * @returns {import('../types/log').LogFn}
 */
function createLogger(level) {
	const logger = loggers[level];
	const logFn = /** @type {import('../types/log').LogFn} */ (_log.bind(null, logger));
	/** @type {Set<string>} */
	const logged = new Set();
	/** @type {import('../types/log').SimpleLogFn} */
...
/**
 * @param {import('../types/id').SvelteRequest | import('../types/id').SvelteModuleRequest} svelteRequest
 * @param {import('svelte/types/compiler/interfaces').Warning[]} warnings
 * @param {import('../types/options').ResolvedOptions} options
 */
export function logCompilerWarnings(svelteRequest, warnings, options) {
	...
	if (sendViaWS) {
		/** @type {import('../types/log').SvelteWarningsMessage} */
		const message = {
			id: svelteRequest.id,
