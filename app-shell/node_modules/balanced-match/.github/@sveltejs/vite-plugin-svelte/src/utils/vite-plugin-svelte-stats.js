...
/** @type {import('../types/vite-plugin-svelte-stats').CollectionOptions} */
...
/**
 * @param {import('../types/vite-plugin-svelte-stats').PackageStats[]} pkgStats
 * @returns {string}
 */
...
export class VitePluginSvelteStats {
	...
	#cache;
	/** @type {import('../types/vite-plugin-svelte-stats').StatCollection[]} */
	#collections = [];
	...
	/**
	 * @param {string} name
	 * @param {Partial<import('../types/vite-plugin-svelte-stats').CollectionOptions>} [opts]
	 * @returns {import('../types/vite-plugin-svelte-stats').StatCollection}
	 */
	startCollection(name, opts) {
		...
		/** @type {import('../types/vite-plugin-svelte-stats').Stat[]} */
		const stats = [];
	...
	/**
	 * @param {import('../types/vite-plugin-svelte-stats').StatCollection} collection
	 */
			...
			if (logResult) {
				...
				log.debug(
					`${collection.name} done.\n${formatPackageStats(
						/** @type {import('../types/vite-plugin-svelte-stats').PackageStats[]}*/ (
	...
	async #aggregateStatsResult(collection) {
		...
		// group stats
		/** @type {Record<string, import('../types/vite-plugin-svelte-stats').PackageStats>} */
		const grouped = {};
		stats.forEach((stat) => {
